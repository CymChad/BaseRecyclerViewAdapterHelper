...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
   ...
   * @deprecated This method is because it can lead to crash: always call this method while RecyclerView is computing a layout or scrolling. Please
   * use {@link #setOnLoadMoreListener(RequestLoadMoreListener, RecyclerView)}
   */
  @Deprecated
  ...
  public T getItem(@IntRange(from = 0) int position) {
    if (position < mData.size()) { return mData.get(position); } else return null;
  }
   ...
   *
   * @param header
   * @param index the position in mHeaderLayout of this header. When index = -1 or index >= child count in mHeaderLayout, the effect of this method is
   * the same as that of {@link #addHeaderView(View)}.
   */
   ...
   *
   * @param footer
   * @param index the position in mFooterLayout of this footer. When index = -1 or index >= child count in mFooterLayout, the effect of this method is
   * the same as that of {@link #addFooterView(View)}.
   */
   ...
   * @param parent Optional view to be the parent of the generated hierarchy or else simply an object that provides a set of LayoutParams values for
   * root of the returned hierarchy
   ...
   *
   * @param position position of the item, which includes the header layout count.
   * @param init whether you are initializing the recyclerView or not. if <strong>true</strong>, it won't notify recyclerView to redraw UI.
   ...
   *
   * @return return the closest parent item position of the IExpandable. if the IExpandable item's level is 0, return itself position. if the item's
   * level is negative which mean do not implement this, return a negative if the item is not exist in the data list, return a negative.
   */
  ...
  public interface OnItemClickListener {
     ...
     *
     * @param adapter the adpater
     * @param view The itemView within the RecyclerView that was clicked (this will be a view provided by the adapter)
  ...
  /**
   * @return The callback to be invoked with an item in this RecyclerView has been long clicked and held, or null id no callback as been set.
   */
  ...
  /**
   * @return The callback to be invoked with an item in this RecyclerView has been clicked and held, or null id no callback as been set.
   */
  ...
  /**
   * @return The callback to be invoked with an itemchild in this RecyclerView has been clicked, or null id no callback has been set.
   */
  @Nullable
  ...
  /**
   * @return The callback to be invoked with an itemChild in this RecyclerView has been long clicked, or null id no callback has been set.
   */
  @Nullable
