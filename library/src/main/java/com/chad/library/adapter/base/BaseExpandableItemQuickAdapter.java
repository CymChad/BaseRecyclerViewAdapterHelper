...
public abstract class BaseExpandableItemQuickAdapter<T extends MultiItemEntity> extends BaseMultiItemQuickAdapter<T>{

    public BaseExpandableItemQuickAdapter(Context context, List<T> data) {
        super(context, data);
    }
