...
// * @constructor
// */
//abstract class BaseSectionQuickAdapter<T : SectionEntity>
//@JvmOverloads constructor(@LayoutRes private val sectionHeadResId: Int,
//                          data: MutableList<T>? = null)
//    : BaseMultiItemQuickAdapter<T>(data) {
//
...
////            setFullSpan(holder)
//            convertHeader(holder, getItem(position))
//        } else {
//            super.onBindViewHolder(holder, position)
//        }
//    }
//
//    fun headerClass() : Class<*> {
//       return BaseViewHolder::class.java
//    }
//
//    fun isSectionHolder(holder: VH) : Boolean = false
//
...
//
//        if (holder.itemViewType == SectionEntity.HEADER_TYPE) {
//            convertHeader(holder, getItem(position), payloads)
//        } else {
