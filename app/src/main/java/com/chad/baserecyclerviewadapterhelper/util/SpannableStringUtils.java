...
public class SpannableStringUtils {
  ...
  public static class Builder {
     ...
     * 设置标识
     *
     * @param flag <ul> <li>{@link Spanned#SPAN_INCLUSIVE_EXCLUSIVE}</li> <li>{@link Spanned#SPAN_INCLUSIVE_INCLUSIVE}</li> <li>{@link
     * Spanned#SPAN_EXCLUSIVE_EXCLUSIVE}</li> <li>{@link Spanned#SPAN_EXCLUSIVE_INCLUSIVE}</li> </ul>
     * @return {@link Builder}
     */
     ...
     * 设置字体
     *
     * @param fontFamily 字体 <ul> <li>monospace</li> <li>serif</li> <li>sans-serif</li> </ul>
     * @return {@link Builder}
     */
     ...
     * 设置对齐
     *
     * @param align 对其方式 <ul> <li>{@link Alignment#ALIGN_NORMAL}正常</li> <li>{@link Alignment#ALIGN_OPPOSITE}相反</li> <li>{@link
     * Alignment#ALIGN_CENTER}居中</li> </ul>
     * @return {@link Builder}
     */
     ...
     * @param style 模糊样式<ul> <li>{@link Blur#NORMAL}</li> <li>{@link Blur#SOLID}</li> <li>{@link Blur#OUTER}</li> <li>{@link Blur#INNER}</li> </ul>
     * @return {@link Builder}
     */
